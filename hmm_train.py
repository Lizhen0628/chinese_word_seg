# -*- coding: utf-8 -*-
# @Time    : 2020/5/2 8:47 下午
# @Author  : lizhen
# @FileName: hmm_train.py
# @Description:
...
if __name__ == "__main__":
    train_filepath = 'data/hmm_train.txt'
    trans_model_path = 'data/prob_trans.model'
    emit_model_path = 'data/prob_emit.model'
    start_model_path = 'data/prob_start.model'
    # trainer = HmmTrain()
    # trainer.train(train_filepath, trans_model_path, emit_model_path, start_model_path)
    hmm_cut = HmmCut(start_model_path, trans_model_path, emit_model_path)
    print(hmm_cut.cut("我们一定要战胜敌人，我们认为它们都是纸老虎。"))