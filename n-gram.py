    ...
    def initial_dict(self, gram1_file, gram2_file):
        ...
        for line in dict_file:
            ...
            if first_word in self.word1_dict_count:
                self.word2_dict_prob[key] = math.log(value / self.word1_dict_count[first_word])  # 取自然对数
            else:
...
if __name__ == '__main__':
    myseg = DNASegment()
    myseg.initial_dict("data/unigram.txt", "data/bigram.txt")
    sequence = "itisatest"
